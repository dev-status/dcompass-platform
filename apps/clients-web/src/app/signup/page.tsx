...
import { FiArrowLeft, FiArrowRight, FiCheckCircle, FiEye, FiEyeOff, FiLock, FiShield, FiStar } from "react-icons/fi";
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 pr-12 text-white outline-none transition placeholder:text-zinc-500 focus:border-white/25"
                      />
                      <button
                        type="button"
