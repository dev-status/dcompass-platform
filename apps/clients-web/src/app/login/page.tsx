...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-[#020308] text-white">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1440px] items-stretch px-5 py-6 sm:px-6 lg:px-10">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col gap-3 border-t border-white/10 pt-5 text-sm text-zinc-400 sm:flex-row sm:items-center sm:justify-between">
                  <p>
                    ...
                    <Link href="/register" className="font-medium transition hover:text-white" style={{ color: colors.accent }}>
                      Regístrate aquí
                    </Link>
                  </p>
