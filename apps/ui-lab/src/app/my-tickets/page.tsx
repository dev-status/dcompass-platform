        ...
        <section className="mx-auto flex w-full max-w-[1440px] flex-col gap-8 px-5 py-8 sm:px-6 lg:px-10 lg:py-10">
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-zinc-300 sm:text-base">Un lugar claro para revisar tus accesos, identificar tu siguiente evento y entrar rápido al boleto correcto cuando lo necesites.</p>
            </div>
          </div>
              ...
              <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.35)] sm:p-8">
                ...
                <div className="mt-6 grid gap-5">
                  {tickets.map((ticket) => (
                    <article
                      key={ticket.id}
                      className={`overflow-hidden rounded-[1.7rem] border bg-white/[0.035] ${ticket.highlight ? "border-white/20 shadow-[0_24px_70px_rgba(130,89,208,0.12)]" : "border-white/10"}`}
                    >
