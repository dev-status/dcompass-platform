...
import { FiArrowRight, FiCalendar, FiClock, FiDownload, FiMapPin, FiShield, FiTag, FiUser, FiX } from "react-icons/fi";
...
export default function TicketDetailPage() {
  ...
  const activeTicket = useMemo(
    () => ticketBundle.tickets.find((ticket) => ticket.id === activeTicketId) ?? null,
    [activeTicketId]
  );
      ...
      <div className="relative">
        ...
        <section className="mx-auto flex w-full max-w-[1440px] flex-col gap-8 px-5 py-8 sm:px-6 lg:px-10 lg:py-10">
          <div className="space-y-3">
            <Link href="/my-tickets" className="inline-flex w-fit items-center gap-2 text-sm font-medium text-zinc-400 transition hover:text-white">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-zinc-300 sm:text-base">Consulta los boletos de esta compra y abre el QR que necesites cuando llegue el momento de entrar.</p>
            </div>
          </div>
              ...
              <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-[0_30px_80px_rgba(0,0,0,0.35)]">
                ...
                <div className="space-y-6 p-6 sm:p-8">
                  ...
                  <div className="grid gap-4">
                    {ticketBundle.tickets.map((ticket) => (
            ...
            <aside className="grid gap-6 xl:sticky xl:top-28">
              <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.24)]">
                ...
                <div className="mt-6 flex flex-col gap-3">
                  ...
                  <Link href="/my-tickets" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/14 px-5 py-3 text-[0.86rem] font-medium tracking-[0.01em] text-zinc-200 transition hover:border-white/30 hover:text-white">
